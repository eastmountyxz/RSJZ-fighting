...
- 2023-03-07 AI安全 + Book基础知识(第11章) + 动静态分析开启 + Word + Paper(AI+文字识别+安全) + 毕设撰写第2章 + 论文修改 + CS + 打印盖章(完成) + 省重大 + 联系CS
- 2023-03-08 AI安全 + Book基础知识(第11章) + 动静态分析开启 + Word + Paper(AI+文字识别+安全) + 毕设撰写第2章 + 论文修改 + CS + **省重大** + 联系CS
