...
- 2023-02-17 AI安全 + Book基础知识(第11章) + 动静态分析开启 + Word + Paper(AI+文字识别+安全) + 毕设撰写第3章 + CS + 现场对接 + **本部**
- 2023-02-18 AI安全 + Book基础知识(第11章) + 动静态分析开启 + Word + Paper(AI+文字识别+安全) + 毕设撰写第3章 + CS + 准备材料
- 2023-02-19 AI安全 + Book基础知识(第11章) + 动静态分析开启 + Word + Paper(AI+文字识别+安全) + 毕设撰写第3章 + CS + **出差重要**
- 2023-02-20 AI安全 + Book基础知识(第11章) + 动静态分析开启 + Word + Paper(AI+文字识别+安全) + 毕设撰写第3章 + CS + **出差重要**
- 2023-02-21 AI安全 + Book基础知识(第11章) + 动静态分析开启 + Word + Paper(AI+文字识别+安全) + 毕设撰写第3章 + CS + **出差重要**
- 2023-02-22 AI安全 + Book基础知识(第11章) + 动静态分析开启 + Word + Paper(AI+文字识别+安全) + 毕设撰写第3章 + CS + 完善材料
